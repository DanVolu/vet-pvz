...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 w-full bg-gray-50 z-50 transition-transform duration-300 shadow-md">
      <div className="container mx-auto px-8 py-4 flex items-center justify-between">
        ...
        <ul className="hidden xl:flex space-x-6 w-1/4 justify-end flex-nowrap text-white font-medium text-lg">
          <li className="bg-gray-800 p-2 px-6 rounded-lg transition-transform transform hover:opacity-85 whitespace-nowrap">
